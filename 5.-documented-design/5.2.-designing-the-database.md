...
!\[\[Picture 1.png]] The “Days” table, used to store the days of the week.

!\[\[Picture 2.png]] The “Dates” table, used to store dates for which attendances can be recorded.

!\[\[Picture 3.png]] The “Semesters” table, used to organise different dates.

!\[\[Picture 4.png]] The “Users” table, where information on different users can be stored.

!\[\[Picture 5.png]] The “Students” table, where different student information can be stored.

!\[\[Picture 6.png]] The “Periods” table, where the 7 periods of each day can be stored individually (three of which can indicate a double-period where the lesson for students remains the same).

!\[\[Picture 7.png]] The “Groups” table, used to assign students and thus teacher timetables to particular groups (each teacher can only be teaching one group per period).

!\[\[Picture 8.png]] The “Lessons” table, where each lesson of the school will be stored to create teacher timetables.

!\[\[Picture 9.png]] The “Attendances” table, where the register of all timetables will be stored for each period, student and date.

!\[\[Picture 10.png]] The “Teachings” table, where teacher timetables will be imported to. Each teacher may generate up to 7periods x 5days = 35 rows according to their timetable.

!\[\[Picture 11.png]] The “Feed” table, used to store all update posts Administrators and Secretaries create through the Desktop Application.
